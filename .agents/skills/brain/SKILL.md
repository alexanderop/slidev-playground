...
- `brain/codebase.md` for project-specific docs
- `brain/plans/index.md` for plans
...
- Maintain hand-written index entrypoints: `brain/principles.md`, `brain/codebase.md`, `brain/plans/index.md`.
- `brain/index.md` is auto-generated by the `auto-index-brain.sh` PostToolUse hook — never edit it by hand.
- If you introduce a new top-level category, add a hand-written `<category>/index.md` (or top-level `<category>.md`) that links to the files inside.
- Every brain file must be linked from one of the hand-written indexes — that is what makes it discoverable, since `brain/index.md` only lists top-level wikilinks.
...
Update the relevant hand-written index (`brain/principles.md`, `brain/codebase.md`, `brain/plans/index.md`) for files you added or removed. Keep indexes link-only and scannable. `brain/index.md` updates itself.
